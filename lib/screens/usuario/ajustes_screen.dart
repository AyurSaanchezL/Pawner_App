  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          // Fondo igual a elegir_familia.dart
          Image.asset(
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        // Chip de Perfil - Ahora de primero y con fondo lavanda
                        _buildBubble(
                          text: "Perfil",
                        ...
                        // Chip de Familia - Ahora de segundo
                        _buildBubble(
                          text: "Familia",
                          color: _orangeBubble,
                          icon: LucideIcons.users,
                          isRightTail: false, // Cambiado para alternar
    ...
    return GestureDetector(
      ...
      child: ClipPath(
        ...
        child: Container(
          ...
          height: 90,
          padding: const EdgeInsets.fromLTRB(25, 10, 25, 20), // Aumentado padding inferior para centrar texto
          color: color,
          child: Row(
